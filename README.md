...
```bash
git clone https://github.com/abbaganiakhila/Sales-Performance-Analysis.git
```  
...
## Connect With Me
- LinkedIn: [Akhila Abbagani](https://www.linkedin.com/in/akhila-abbagani/)
...
### About the Developer
Akhila Abbagani is a Data Analyst with over 3 years of experience delivering analytics, business intelligence, and cloud-based data solutions across healthcare and insurance domains. Expert in SQL, Python, and Power BI, she specializes in transforming complex data into actionable insights through scalable ETL pipelines and interactive dashboards. This project serves as a demonstration of advanced analytical modeling and DAX optimization techniques.
